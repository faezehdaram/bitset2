...
.container {
   ...
   <p style="font-size:30px; text-align: center;color: black;">به نام خدا</p>
       ...
       <br>
       <h1 id="home">برنامه کلاس‌ها:</h1><br>
       <div>
      
        <table>
         <tr>
         <th style="width: 10%;">شماره شناسه</th>
         <th>نام درس</th>
          <th>زمان کلاس</th>
          <th >نام مدرس</th>
    ...
    <h1 id="home">ثبت نام در کلاس ها:</h1><br>
     ...
     <div class="grid-item">
       ...
       <div class="form-control">
            <label for='name'>شناسه درس</label>
              <input type="text" id="education_id" name="education_id" placeholder="شناسه" autocomplete="off">
          </div> <br>
