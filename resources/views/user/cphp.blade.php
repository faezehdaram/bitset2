...
<?php
      ...
      $temp5=@$_GET["text5"];
      $number=0;
   $text=array($temp1,$temp2,$temp3,$temp4,$temp5);
   $right=array("skh","simi","flout","!=","gets");
   $len=count($right);
   if(isset($temp1)&isset($temp2)&isset($temp3)&isset($temp4)&isset($temp5))
   {
     for($i=0;$i<$len;$i++)
      ...
      if($number==5)
       {
            ...
            <h3 style = margin-top:50px;float:center;>پیشنهاد ما شرکت در دوره فوق پیشرفته زبان c است.</h3>
     ...
     else if($number>3)
      {
        ...
        <h3 style = margin-top:50px;float:center;>پیشنهاد ما شرکت در دوره پیشرفته زبان c است.</h3>
        <form action='/schedule_user' method='get'>
        زبان برنامه نویسیC<br><br>
        <input type='submit' value='مشاهده برنامه کلاس ها'> <br> <br>
        </form>
      ...
      else
      {
        ...
        <h3 style = margin-top:50px;float:center;>پیشنهاد ما شرکت در دورهاابتدایی زبان c است.</h3>
        <form action='/schedule_user' method='get'>
        زبان برنامه نویسیC<br><br>
        <input type='submit' value='مشاهده برنامه کلاس ها'> <br> <br>
        </form>
