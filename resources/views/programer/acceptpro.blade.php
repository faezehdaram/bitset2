      ...
      <div>
        ...
        <table>
         ...
         <th style="width: 7%;">شماره شناسه</th>
          <th style="width: 14%;">نام</th>
          <th >مشخصات</th>
          <th style="width: 14%;">تاریخ تحویل</th>
          <th style="width: 14%;">نام کارفرما</th>
         </tr>
       ...
       <div class="grid-item">
         ...
         <div class="form-control">
              <label for='name'>شناسه پروژه</label>
                <input type="text" id="name" name="id" placeholder="شناسه" autocomplete="off">
            </div> <br>
          <div class="form-control">
              <label for='name'>هزینه انجام پروژه</label>
            ...
            <div class="form-control">
              <label for='name'>گزارش  روزانه</label>
                <input type="text" id="name" name="daily" placeholder="نام " autocomplete="off">
            </div> <br>
            <div class="form-control">
            ...
            <label for='name'>نام کارفرما</label>
                <input type="text" id="name" name="employername" placeholder="نام " autocomplete="off">
            </div> <br>
